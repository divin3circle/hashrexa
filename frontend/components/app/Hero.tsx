...
function Hero() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center mt-10 md:flex-row md:justify-between gap-2"
    >
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.2 }}
        className="rounded-[2rem] p-4 w-full md:w-1/2  h-[450px] bg-gray-100 relative"
      >
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        ...
        className="rounded-[2rem] p-4 w-full md:w-1/2  h-[450px] bg-[#FF9494] relative"
      >
        <motion.div
