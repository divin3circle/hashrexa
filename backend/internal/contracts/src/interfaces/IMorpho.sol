...
interface IMorphoBase {
    ...
    function supply(uint256 assets, uint256 shares, address onBehalf, bytes memory data)
        external
    ...
    function repay(uint256 assets, uint256 shares, address onBehalf, bytes memory data)
        external
    ...
    function liquidate(address borrower, uint256 seizedAssets, uint256 repaidShares, bytes memory data)
        external
